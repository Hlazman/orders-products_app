    ...
    <div>
      ...
      <Form onSubmit={handleSubmit} onReset={handleReset}>
        ...
        <Form.Control 
          ...
          className={title.trim() === '' && showAlert ? 'is-invalid' : ''} 
        />
      ...
      <Form.Group controlId="formDate" className='mb-3'>
        ...
        <Form.Control 
          ...
          className={date.trim() === '' && showAlert ? 'is-invalid' : ''} 
        />
      ...
      <Form.Group controlId="formDescription" className='mb-3'>
        ...
        <Form.Control 
          ...
          className={description.trim() === '' && showAlert ? 'is-invalid' : ''} 
        />
      ...
      <Form.Group controlId="formProduct" className='mb-3'>
        ...
        className={selectedProduct.trim() === '' && showAlert ? 'is-invalid' : ''}
        >
